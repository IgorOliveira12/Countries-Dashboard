...
📂 Project Structure src/ ├─ components/ │ ├─ CountryCard.jsx │ ├─ Filters.jsx │ ├─ Loader.jsx │ └─ EmptyState.jsx ├─ hooks/ │ └─ useCountries.js ├─ pages/ │ └─ Home.jsx ├─ App.jsx ├─ main.jsx └─ index.css
